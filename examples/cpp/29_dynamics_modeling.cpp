// Dynamics Modeling Demo
// It builds a simple 2-link robot with a single revolute joint and
// computes a transformation between links.
//
// Usage example:
//   ./example_29_dynamics_modeling 
//
