// Servo Off Demo
// This example demonstrates how to bring up the robot, wait 5 seconds, then disable the control
// manager and turn servo off.
//
// Usage example:
//   ./example_21_servo_off --address 192.168.30.1:50051 --model a --power ".*" --servo "^(head).*"
//
